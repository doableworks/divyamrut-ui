    ...
    <section>
      <div className="common_page_width !space-y-6 !p-5">
        <div>
          ...
          <p className="section-content !text-justify !mb-3">
            When ancient traditional modalities get harmoniously interwoven with
            modern lifestyle, a synergistic outcome of holistic well-being
            dawns.
          </p>

          <p className="section-content !text-justify !mb-3">
            From subtle to cellular, at atomic as well as cosmic level, you as
            an individual are new in every moment! Every moment is a new moment
            for a new you.
          </p>

          <p className="section-content !text-justify !mb-3">
            Well-being is a state of feeling fit and robust at the level of
            body, fresh &nbsp;&amp;&nbsp; unpolluted at the level of the mind.
            Healing happens when you learn to live without carrying any dis-ease
            in the body or trauma in the mind from any happenings of the past.
          </p>
        ...
        <div>
          <p className="highlight-heading !text-left !mb-3">Approach:</p>
          <p className="section-content !text-justify">
            ...
            thoughts, emotions and body lies primarily in the domain of the
            mind.
          </p>

          <p className="section-content !text-justify !mb-3">
            We at Nityanava strive to look at an individual holistically.
          </p>

          <p className="section-content !text-justify !mb-3">
            Life expressions account to a combination of bodily challenges,
            individual mindset, emotional state, financial position, social
            circle and the skill of working on your personal growth.
          </p>

          <p className="section-content !text-justify !mb-3">
            Here we take all the above in consideration to curate a personalised
            well-being plan that heals the areas that need attention in life to
            unveil and blossom the ever-present newness &nbsp;&amp;&nbsp;
            freshness to make learning, growing and exploring life a
            celebration.
          </p>
        </div>
      </div>
