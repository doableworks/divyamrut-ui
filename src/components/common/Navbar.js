...
//               <h5
//                 className={`${
//                   hasHover == "HomePage" ? "text-a2c0d56" : "#FFFFFF"
...
//             {/* Dropdown */}
//             <div
//               className={`absolute left-0 hidden group-hover:block shadow-lg  py-2 px-4 text-nowrap cursor-pointer
//             bg-white hover:bg-d49ac81
//             text-a2c0d56 hover:text-text ${
//               pathname == "/home-page-2" ? "text-text bg-d49ac81" : ""
//             }
//             `}
//             >
//               <h5 onClick={() => handleMoveRoute("/home-page-2")}>
//                 HomePage 2
//               </h5>
//             </div>
//           </div>
...
//           <h5
//             className={`cursor-pointer hover:text-a2c0d56 ${
//               pathname == "/mission-and-vision" ? "text-a2c0d56" : "text-[#FFFFFF]"
//             }`}
...
//               <h5
//                 className={`${
//                   hasHover == "Services" ? "text-a2c0d56" : "#FFFFFF"
//                 } leading-[3.5em] cursor-pointer`}
//               >
//                 Services
//               </h5>
...
//             bg-white hover:bg-d49ac81
//             text-a2c0d56 hover:text-text ${
//               pathname == "/pricing-plan" ? "text-text bg-d49ac81" : ""
//             }
//             `}
//             >
//               <h5 onClick={() => handleMoveRoute("/pricing-plan")}>
//                 Pricing Plan
//               </h5>
//             </div>
//           </div>
