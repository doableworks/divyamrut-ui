...
//       <div className="sticky top-20 lg:w-1/2  flex flex-col items-center">
//         <div className="w-[100%] md:w-[80%] min-w-[400px] max-w-[700px] h-auto border border-gray-300 rounded-lg overflow-hidden">
//           <img
...
//             <div
//               key={index}
//               className="w-24 h-auto border border-gray-300 rounded-md overflow-hidden"
//             >
//               <img
//                 src="/asset/home/ayurvedic-supplement.jpg"
//                 alt={`Thumbnail ${index}`}
