...
const TherapyName = () => {
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div className="mb-28 lg:max-w-[80%] p-5 xl:p-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-28 lg:gap-40 items-center">
          <figure className="p-3 flex flex-col justify-center md:items-start">
            ...
            <button className="site-button-primary !hidden md:!inline !capitalize">Book a Session</button>
          </figure>
